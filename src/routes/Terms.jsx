...
const Terms = () => {
    return (
        <div className='p-20'>
            <h2 className='text-purple-600 font-bold italic text-5xl text-center mb-5   hover:text-4xl transform hover:scale-110  transition delay-150 duration-300 ease-in-out '>Terms and Condition</h2>
